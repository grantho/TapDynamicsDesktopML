...
public class Evaluator {
	...
	public static void printPerformance(Map<Object, PerformanceMeasure> performance){
		for(Object key : performance.keySet()){
			...
			Utility.writeToFile(FILENAME, "Performance for class '" +key + "':\r\n");
			Utility.writeToFile(FILENAME, "  precision: " + p.getPrecision() + "\r\n");
			Utility.writeToFile(FILENAME, "  recall: " + p.getRecall() + "\r\n");
			Utility.writeToFile(FILENAME, "false negative rate: " + p.getFNRate() + "\r\n");
			Utility.writeToFile(FILENAME, "false positive rate: " + p.getFPRate()  + "\r\n");
			Utility.writeToFile(FILENAME, "  accuracy: "+p.getAccuracy() + "\r\n");
		}
	}
